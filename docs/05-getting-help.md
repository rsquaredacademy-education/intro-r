...
[Stack Overflow](https://stackoverflow.com/questions/tagged/r) is a great place to visit if you are having trouble with R code or packages. Chances are high that someone has already encountered the same or similar problem and you can use the answers given by R experts. In case you have encountered a new problem or issue, you can ask for help by providing a reproducible example of your analysis along with the R code. Use the [reprex](https://reprex.tidyverse.org/) package to create reproducible examples. 

### Twitter

The R community is very active on Twitter/X and there are lot of R experts who are willing to help those who are new to R. Use the hashtag [#rstats](https://twitter.com/search?q=%23rstats) if you are asking for help or guidance on Twitter/X. Many community members are also active on Mastodon, Bluesky, and LinkedIn.

### RStudio Community

[RStudio Community](https://community.posit.co/) is similar to Stack Overflow. You can ask questions
related to RStudio, Shiny and tidyverse.

### RStudio 

[RStudio](https://posit.co/resources/) has very good resources including cheatsheets, webinars and blogs. 

### Reddit

[Reddit](https://www.reddit.com/r/rstats/) is another place where you can look for help. The discussions are moderated by R experts. There are subreddits for [Rstats](https://www.reddit.com/r/rstats/), [Rlanguage](https://www.reddit.com/r/Rlanguage/), [Rstudio](https://www.reddit.com/r/RStudio/) and [Rshiny](https://www.reddit.com/r/rshiny/).
...
The `help.start()` function opens the documentation page in your browser. Here you can find manuals, reference and other materials.
...
A vignette is a long form guide to a R package. You can access the vignettes available using `vignette()`. It will display a list of vignettes available in installed packages.
...
`RsiteSearch()` will search for specified topics in help pages, vignettes and task views using the search engine at this  [link](https://search.r-project.org/) and return the result in a browser. 
